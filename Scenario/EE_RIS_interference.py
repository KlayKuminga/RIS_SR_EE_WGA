...
def EE_RIS_I(NumBSAnt, NumRISEle, NumUE, NumPUE, NumSUE, RISgroup, Bandwidth, sigma2,
    ...
    model.obj = Objective(expr=obj_function(model, PT_static, RIS_static, PUE_static, SUE_static), sense=maximize)  #-----------------setting objective function-------------------#
    ...
    print("Solver Obj EERIS: ", RIS_I_BB_objective)
    # print("*************************************************************************")
